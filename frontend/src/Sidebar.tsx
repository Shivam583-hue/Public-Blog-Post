      ...
      <div className="p-12">
        <div className="pl-[42px] flex">
          ...
          <h1
            ...
            className="text-gray-300 font-mono pt-2 text-2xl "
          >
            Blugify
          </h1>
        </div>
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className=" mt-8 bg-black text-white w-64 h-12 rounded-3xl font-sans flex pt-1  pl-12 font-semibold text-[25px] hover:bg-[#343635] "
        >
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.04 }}
          whileTap={{ scale: 0.98 }}
          className="mt-3 bg-black text-white w-64 h-12 rounded-3xl font-sans flex pt-1  pl-12 font-semibold text-[25px] hover:bg-[#343635] "
        >
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.04 }}
          whileTap={{ scale: 0.98 }}
          className="mt-9 bg-gray-600 text-white w-[220px] h-16 rounded-[50px] font-sans flex pt-[13px] pl-10 ml-10 font-semibold text-[25px]  hover:bg-[#363434] "
        >
          <div className="pt-[6px] pr-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.04 }}
          whileTap={{ scale: 0.98 }}
          className="mt-[140px] bg-black text-white w-64 h-12 rounded-3xl font-sans flex pt-1 pl-12 font-semibold text-[25px] hover:bg-[#343635] "
        >
          <div className="pt-[6px] pr-1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
